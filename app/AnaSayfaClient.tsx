    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: 'Inter, sans-serif' }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .sektor-btn.aktif .sb-icon { font-size: 24px; }
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ background: 'white', borderRadius: '16px', padding: '8px', display: 'flex', gap: '8px', maxWidth: '640px', margin: '0 auto', boxShadow: '0 8px 32px rgba(0,0,0,0.2)' }}>
            ...
            <input value={sehirFiltre} onChange={e => setSehirFiltre(e.target.value)}
              placeholder="Şehir"
              style={{ width: '120px', padding: '10px 12px', border: 'none', outline: 'none', fontSize: '14px', fontFamily: 'inherit', borderLeft: '1px solid #e2e8f0', borderRadius: '0' }} />
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        {/* Sektör Filtreleri */}
        <div style={{ display: 'flex', gap: '10px', overflowX: 'auto', paddingBottom: '8px', marginBottom: '24px' }} className="no-scroll">
          <button onClick={() => setAktifSektor('')}
            className={`sektor-btn ${!aktifSektor ? 'aktif' : ''}`}>
      ...
      <div style={{ background: '#0f172a', padding: '48px 24px', textAlign: 'center', marginTop: '32px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <button onClick={() => router.push('/uye-ol?tip=hizmet_veren')}
