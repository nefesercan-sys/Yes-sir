...
// Google Business Profile — CID: 1496201377277644027
const MAPS_SHORT = 'https://maps.app.goo.gl/i73c4xKZwr7uaSjbA';
const MAPS_CID   = 'https://www.google.com/maps?cid=1496201377277644027';
...
// SEO için Konyaaltı mahalleleri (genişletildi)
  ...
  '@graph': [
    {
      ...
      hasMap: 'https://www.google.com/maps?cid=1496201377277644027',
      sameAs: [
        'https://maps.app.goo.gl/i73c4xKZwr7uaSjbA',
        'https://www.google.com/maps?cid=1496201377277644027',
      ],
    ...
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'Konyaaltı Hurma, Liman, Uncalı, Sarısu, Çakırlar, Meltem, Göbi mahallelerine eve servis var mı?', acceptedAnswer: { '@type': 'Answer', text: `Evet! Terzi Can olarak Konyaaltı'nın tüm mahallelerine — Hurma, Liman, Uncalı, Sarısu, Gürsu, Çakırlar, Meltem, Göbi, Öğretmenevleri dahil — kapıdan alım ve teslimat yapıyoruz. Terziniz adresinize gelir, ölçünüzü alır, kıyafetinizi teslim eder. WhatsApp: ${PHONE}` } },
        { '@type': 'Question', name: 'Adrese gelen terzi servisi nasıl çalışır?', acceptedAnswer: { '@type': 'Answer', text: `Randevu alın, terzimiz adresinize gelir, ölçü alır veya kıyafetlerinizi teslim alır. En geç 24 saat içinde işlem tamamlanır ve adresinize teslim edilir. Siz yorulmayın, terzi size gelsin! WhatsApp: ${PHONE}` } },
...
const SERVIS_ADIMLARI = [
  ...
  { numara: '04', baslik: 'Adresinize Teslim', aciklama: 'Hazır olan kıyafetleriniz tekrar adresinize getirilir. Siz hiçbir yere gitmenize gerek yok!' },
];
      ...
      <main style={{ fontFamily: SANS, background: BG, color: METIN, minHeight: '100vh' }}>
        ...
        <section style={{
          ...
          <div style={{
            ...
            background: "url('https://images.pexels.com/photos/3761509/pexels-photo-3761509.jpeg?w=1600&q=60&auto=compress&fit=crop') center/cover",
            opacity: .07,
          }} />
          ...
          <div style={{ maxWidth: '960px', margin: '0 auto', position: 'relative' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(110px,1fr))', gap: '1px', background: 'rgba(255,255,255,.06)', marginTop: '3rem', maxWidth: '700px' }}>
              {[['⭐ 4.9','94 Google Yorum'],['10+ Yıl','Deneyim'],['Max 24 Sa','Aynı Gün Teslim'],['Tüm Konyaaltı','Adrese Servis']].map(([t,d]) => (
        ...
        {/* ── TERZİ ÇAĞIR — ADRESE GELEN TERZİ SERVİSİ ────────────────────── */}
        <section style={{
          ...
          <div style={{ maxWidth: '900px', margin: '0 auto', position: 'relative' }}>
            ...
            {/* Mahalle listesi — küçük badge'ler */}
            <div style={{ marginTop: '2rem', textAlign: 'center' }}>
              <div style={{ fontSize: '.7rem', color: 'rgba(255,255,255,.3)', letterSpacing: '.2em', textTransform: 'uppercase', marginBottom: '1rem' }}>
                Servis Verdiğimiz Mahalleler
              </div>
              <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '.5rem' }}>
                {['Hurma', 'Uncalı', 'Sarısu', 'Liman', 'Çakırlar', 'Gürsu', 'Öğretmenevleri', 'Meltem', 'Göbi', 'Konyaaltı Merkez', 'Arapsuyu', 'Pınarbaşı', 'Altınkum', 'Toros', 'Siteler'].map(m => (
                  <span key={m} style={{ 
                    fontSize: '.7rem', color: 'rgba(255,255,255,.45)', 
                    background: 'rgba(255,255,255,.05)', 
                    border: '1px solid rgba(184,151,90,.2)',
                    padding: '.3rem .75rem', borderRadius: '2px'
                  }}>
                    {m}
                  </span>
                ))}
        ...
        {/* ── FİYAT LİSTESİ (YENİ & GÜNCELLENMİŞ) ────────────────────────── */}
        ...
        <section id="konum" style={{ background: BG, padding: '4.5rem 1.5rem' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: SERIF, fontSize: '1.9rem', color: KOYU, marginBottom: '.4rem' }}>
              Terzi Can — Konyaaltı Konumu
            </h2>
            <p style={{ color: GRI, fontSize: '.88rem', marginBottom: '2rem' }}>
              Konyaaltı Liman Mahallesi merkezinde. Google Maps'te <strong style={{ color: METIN }}>"Konyaaltı Terzi"</strong> aratarak bize ulaşabilirsiniz.
            </p>
            ...
            <div style={{ position: 'relative', width: '100%', borderRadius: '2px', overflow: 'hidden', boxShadow: '0 4px 30px rgba(28,24,20,.1)', border: `1px solid rgba(184,151,90,.2)` }}>
              <iframe
                ...
                title="Terzi Can Konyaaltı — Google Harita"
              />
            </div>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginTop: '1.5rem' }}>
              ...
              <a
                href={`https://search.google.com/local/writereview?placeid=ChIJ-4wVtTmTwxQRwDB9jfqqquoA`}
                target="_blank" rel="noopener noreferrer"
                style={{
                  display: 'inline-flex', alignItems: 'center', gap: '.5rem',
            ...
            <div style={{ marginTop: '1.5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: '1px', background: 'rgba(184,151,90,.1)' }}>
              {[
                { icon: '📍', label: 'Adres', value: 'Liman Mah., Konyaaltı / Antalya' },
                { icon: '🕐', label: 'Çalışma Saatleri', value: 'Pzt–Cmt: 09:00 – 19:00' },
                { icon: '⭐', label: 'Google Puanı', value: '4.9 / 5 · 94 Yorum' },
        ...
        <footer style={{ textAlign: 'center', padding: '3rem 1.5rem', background: KOYU2, color: 'rgba(255,255,255,.5)', fontSize: '.75rem', borderTop: `1px solid rgba(255,255,255,.05)` }}>
          ...
          <p style={{ fontSize: '.65rem', color: 'rgba(255,255,255,.2)' }}>
            <a href={MAPS_CID} target="_blank" rel="noopener noreferrer" style={{ color: 'rgba(255,255,255,.25)', textDecoration: 'none' }}>
              Google Business · Konyaaltı Terzi — Terzi Dikim Tamir Tadilat
            </a>
          </p>
        </footer>
