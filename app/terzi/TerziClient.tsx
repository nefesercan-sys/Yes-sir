...
const C = {
  tr: {
    ...
    sub: 'Bay Terzi · Bayan Terzi · Dikiş Atölyesi · Tadilat · Üniforma · Nakış · Kuru Temizleme',
    ...
    bayBayanHeading: 'Bay & Bayan Terzi — Erkek ve Kadın Kıyafet Dikimi',
    bayHeading: '✦ Bay Terzi — Erkek Kıyafet Dikimi Antalya',
    bayDesc: 'Erkek takım elbise dikimi, erkek pantolon kısaltma ve tadilatı, erkek gömlek dikimi, ceket tadilatı, kol kısaltma, fermuar değişimi, yırtık onarımı. Blazer, smoking, damatlık dikimi. Özel ölçü erkek kıyafeti için tüm Antalya\'ya araçlı servis.',
    bayanHeading: '✦ Bayan Terzi — Kadın Elbise Dikimi Antalya',
    bayanDesc: 'Kadın elbise dikimi, bluz dikimi, etek dikimi ve kısaltma, elbise daraltma ve tadilatı, abiye tamiri ve kısaltma, gelinlik tadilatı, nişan elbisesi dikimi, kına kıyafeti dikimi. Büyük beden bayan kıyafeti, bebek elbisesi ve çocuk kıyafeti dikimi. Özel ölçü kadın kıyafetleri için tüm Antalya\'ya hizmet.',
    atolyeHeading: '✦ Dikiş Atölyesi Antalya — Fason ve Seri Üretim',
    atolyeDesc: 'Antalya dikiş atölyemizde kalıp çıkarma, model tasarımı, kesim, dikim, ütü ve paketleme hizmetleri sunuyoruz. Numune dikimi, prototip üretimi, fason üretim ve seri imalat yapıyoruz. Markalar, butikler, e-ticaret firmaları ve kurumsal şirketler için tam üretim paketi. Sweatshirt, eşofman, polo yaka seri dikimi; nakış ve logo baskı ile kişiselleştirme.',
    faq: [
      ['Paça kısaltma ve pantolon kısaltma kaç lira? 2025–2026 fiyatı?', "Paça kısaltma ve pantolon kısaltma ₺150'den başlar. Kot paça ₺150, kumaş pantolon ₺175. Hem bay hem bayan pantolon kısaltma yapıyoruz. WhatsApp'tan kıyafetinizin fotoğrafını gönderin — 30 dakika içinde fiyat bildiririz."],
      ['Bay terzi Antalya — erkek kıyafet dikimi ve tadilatı yapıyor musunuz?', "Evet! Bay terzisi olarak erkek takım elbise dikimi, erkek pantolon kısaltma, erkek gömlek dikimi, ceket tadilatı, kol kısaltma yapıyoruz. Blazer, smoking, damatlık dikimi de hizmetlerimiz arasında. WhatsApp: +90 531 898 64 18"],
      ['Bayan terzi Antalya — kadın elbise dikimi ve tadilatı yapıyor musunuz?', "Evet! Bayan terzisi olarak kadın elbise dikimi, bluz dikimi, etek dikimi ve kısaltma, elbise daraltma, abiye tamiri, gelinlik tadilatı yapıyoruz. Büyük beden bayan dikimi, bebek ve çocuk kıyafeti de dikiyoruz. WhatsApp: +90 531 898 64 18"],
      ['Dikiş atölyesi Antalya — fason üretim, kalıp, seri imalat yapıyor musunuz?', "Evet! Antalya dikiş atölyemizde kalıp çıkarma, fason üretim, seri imalat, numune dikimi ve prototip üretimi yapıyoruz. Markalar, butikler ve e-ticaret firmaları için tam üretim paketi. WhatsApp: +90 531 898 64 18"],
      ...
      ['Kuru temizleme ve ütü hizmeti Antalya fiyatları?', "Kuru temizleme ₺300'den, mont kuru temizleme ₺500'den, çamaşır ve ütü hizmeti ₺80/kg'dan başlar. Otel ve adreslerden kurye ile alım yapıyoruz. 24 saat ekspres teslimat."],
      ...
      ['Otel ve restoran üniforması üretimi yapıyor musunuz?', 'Evet. Otel personel, resepsiyon, kat görevlisi, aşçı, garson, meydancı, kapıcı, güvenlik, spa, animatör üniforması üretiyoruz. Tasarım + kalıp + seri imalat + nakış hepsi tek elden.'],
    ...
    seoIntro: "Antalya'nın köklü terzisi Terzi Can olarak Konyaaltı merkezimizden tüm Antalya ilçelerine hizmet veriyoruz. Bay terzisi olarak erkek takım elbise dikimi, erkek pantolon kısaltma, erkek gömlek dikimi, ceket ve kol tadilatı yapıyoruz. Bayan terzisi olarak kadın elbise dikimi, etek dikimi, bluz dikimi, elbise daraltma, abiye tamiri, gelinlik tadilatı ve büyük beden bayan kıyafeti dikiyoruz. Dikiş atölyemizde kalıp çıkarma, fason üretim, seri imalat ve numune dikimi sunuyoruz. Paça kısaltma, pantolon kısaltma, etek kısaltma, fermuar değişimi, kıyafet tamiri, kuru temizleme ve ütü hizmetleri de veriyoruz. Otel üniforma, aşçı üniforma, garson üniforma, resepsiyon üniforma, okul üniforma ve spor üniforma üretimi yapıyoruz. Sweatshirt ve eşofman dikimi, nakış ve logo baskı hizmetleri sunulmaktadır. Eve gelen terzi, otele gelen terzi ve araçlı terzi servisimizle Konyaaltı, Lara, Belek, Kemer, Alanya ve Manavgat dahil tüm Antalya'ya kapınıza kadar geliyoruz.",
  },
  en: {
    badge: '✦ Antalya · Tailor Can', h1: "Antalya's", h1em: 'Master Tailor',
    sub: "Men's Tailor · Women's Tailor · Sewing Workshop · Alterations · Uniforms · Embroidery · Dry Cleaning",
    ...
    bayBayanHeading: "Men's & Women's Tailor — Custom Tailoring Antalya",
    bayHeading: "✦ Men's Tailor — Bespoke Menswear Antalya",
    bayDesc: "Bespoke suits, trouser hemming and alterations, shirt making, jacket alterations, sleeve shortening, zip replacement, tear repair. Blazers, tuxedos, groom suits. Mobile service for all Antalya districts.",
    bayanHeading: "✦ Women's Tailor — Dress Making & Alterations Antalya",
    bayanDesc: "Dress making, blouse making, skirt making and shortening, dress taking in and alterations, evening gown repair and shortening, wedding dress alterations, engagement dress, henna outfit. Plus-size women's clothing, baby dresses and children's clothing. Custom women's wear, delivery anywhere in Antalya.",
    atolyeHeading: '✦ Sewing Workshop Antalya — Contract Manufacturing & Mass Production',
    atolyeDesc: 'Our Antalya sewing workshop offers pattern making, model design, cutting, sewing, ironing and packaging. Sample sewing, prototype production, contract manufacturing and mass production. Full production packages for brands, boutiques, e-commerce companies and corporates. Sweatshirt, tracksuit and polo mass production; logo embroidery and printing.',
    faq: [
      ['How much does trouser hemming cost in Antalya 2025-2026?', 'Trouser hemming starts from ₺150. WhatsApp us a photo for a free quote in 30 minutes. We do both men\'s and women\'s trouser hemming.'],
      ['Do you offer men\'s tailoring in Antalya?', 'Yes! As a men\'s tailor we offer bespoke suit making, trouser hemming, shirt making, jacket alterations, sleeve shortening. Blazers, tuxedos and groom suits also available. WhatsApp: +90 531 898 64 18'],
      ['Do you offer women\'s tailoring in Antalya?', 'Yes! As a women\'s tailor we offer dress making, blouse making, skirt shortening, dress alterations, evening gown repair, wedding dress alterations. Plus-size clothing, baby and children\'s clothing too. WhatsApp: +90 531 898 64 18'],
      ['Do you have a sewing workshop for mass production in Antalya?', 'Yes! Our Antalya sewing workshop offers pattern making, contract manufacturing, mass production and sample sewing. Full production packages for brands, boutiques and e-commerce. WhatsApp: +90 531 898 64 18'],
      ...
      ['Dry cleaning and ironing prices in Antalya?', 'Dry cleaning from ₺300, coat dry cleaning from ₺500, laundry and ironing from ₺80/kg. Courier pickup from hotels. 24-hour express.'],
    ...
    seoIntro: "Tailor Can — Antalya's most experienced English-speaking tailor for men and women. Men's tailor: bespoke suits, trouser hemming, shirt making, jacket alterations. Women's tailor: dress making, skirt shortening, dress alterations, wedding dress alterations, evening gown repair. Sewing workshop: pattern making, contract manufacturing, mass production. Trouser hemming, zip replacement, dry cleaning, ironing, embroidery, logo printing. Hotel, restaurant, medical and school uniform production. Express 24–48h service. Hotel pickup and delivery across all Antalya districts.",
  },
  ru: {
    badge: '✦ Анталья · Портной Кан', h1: 'Лучший', h1em: 'Портной Антальи',
    sub: 'Мужской · Женский · Ателье · Подгонка · Химчистка · Форма · Вышивка',
    ...
    bayBayanHeading: 'Мужской и женский портной — пошив одежды в Анталье',
    bayHeading: '✦ Мужской портной — пошив мужской одежды в Анталье',
    bayDesc: 'Пошив мужских костюмов, подгонка и укорачивание брюк, пошив рубашек, подгонка пиджаков, укорачивание рукавов, замена молнии, ремонт разрывов. Блейзеры, смокинги, костюм жениха. Выездной сервис по всей Анталье.',
    bayanHeading: '✦ Женский портной — пошив женской одежды в Анталье',
    bayanDesc: 'Пошив женских платьев, блузок, юбок и их укорачивание, ушивание и подгонка платьев, ремонт и укорачивание вечерних платьев, подгонка свадебных платьев, платье на помолвку. Одежда больших размеров, детская одежда и одежда для малышей. Пошив женской одежды на заказ по всей Анталье.',
    atolyeHeading: '✦ Швейное ателье в Анталье — производство и серийный пошив',
    atolyeDesc: 'Наше швейное ателье в Анталье предлагает разработку лекал, дизайн моделей, раскрой, пошив, глажку и упаковку. Пошив образцов, прототипов, серийное производство и контрактный пошив. Полный производственный пакет для брендов, бутиков, интернет-магазинов. Серийный пошив толстовок, спортивных костюмов и поло; вышивка и нанесение логотипа.',
    faq: [
      ['Сколько стоит подгонка брюк в Анталье 2025–2026?', 'Подгонка брюк от ₺150. Отправьте фото в WhatsApp — ответим за 30 минут. Подгоняем брюки для мужчин и женщин.'],
      ['Есть ли мужской портной в Анталье?', 'Да! Как мужской портной мы предлагаем пошив костюмов, подгонку и укорачивание брюк, пошив рубашек, подгонку пиджаков, укорачивание рукавов. WhatsApp: +90 531 898 64 18'],
      ['Есть ли женский портной в Анталье?', 'Да! Как женский портной мы предлагаем пошив платьев, блузок, юбок, подгонку платьев, ремонт вечерних платьев, подгонку свадебных платьев. Одежда больших размеров, детская одежда. WhatsApp: +90 531 898 64 18'],
      ['Есть ли швейное ателье в Анталье для серийного производства?', 'Да! В нашем швейном ателье в Анталье: разработка лекал, контрактный пошив, серийное производство, пошив образцов. Для брендов и интернет-магазинов. WhatsApp: +90 531 898 64 18'],
      ...
      ['Цены на химчистку и глажку в Анталье?', 'Химчистка от ₺300, пальто от ₺500, стирка и глажка от ₺80/кг. Курьер заберёт из отеля. Экспресс 24 часа.'],
    ...
    seoIntro: 'Портной Кан — опытный портной в Анталье, обслуживаем по-русски. Мужской портной: пошив костюмов, подгонка брюк, пошив рубашек, подгонка пиджаков. Женский портной: пошив платьев, укорачивание юбок, подгонка платьев, свадебные платья, вечерние наряды. Швейное ателье: лекала, серийное производство, контрактный пошив. Химчистка, глажка, вышивка, нанесение логотипа. Форма для гостиниц, ресторанов, медицины и школ. Экспресс 24–48 часов. Забор и доставка в любой отель Антальи.',
  },
  de: {
    badge: '✦ Antalya · Schneider Can', h1: 'Antalyas', h1em: 'Meisterschneider',
    sub: 'Herrenschneider · Damenschneider · Atelier · Änderungen · Uniformen · Stickerei · Reinigung',
    ...
    bayBayanHeading: 'Herren- & Damenschneider — Maßanfertigung in Antalya',
    bayHeading: '✦ Herrenschneider — Herrenmaßschneiderei Antalya',
    bayDesc: 'Maßanzüge, Hosenänderungen, Hemden nähen, Jackenanpassungen, Ärmekürzen, Reißverschluss ersetzen, Risse reparieren. Blazer, Smoking, Bräutigamanzug. Mobiler Service für alle Antalya-Bezirke.',
    bayanHeading: '✦ Damenschneiderin — Damenkleidung nähen & ändern Antalya',
    bayanDesc: 'Kleider nähen, Blusen nähen, Röcke nähen und kürzen, Kleider einengen und ändern, Abendkleider reparieren und kürzen, Brautkleid anpassen, Verlobungskleid. Übergrößen, Babykleider und Kinderkleidung. Maßanfertigungen für Damen in ganz Antalya.',
    atolyeHeading: '✦ Nähwerkstatt Antalya — Lohnfertigung und Serienproduktion',
    atolyeDesc: 'Unsere Antalya Nähwerkstatt bietet Schnittmuster, Modelldesign, Zuschnitt, Nähen, Bügeln und Verpackung. Musterfertigung, Prototypen, Lohnfertigung und Serienproduktion. Vollständige Produktionspakete für Marken, Boutiquen, E-Commerce und Unternehmen. Sweatshirts, Trainingsanzüge und Polo-Serienproduktion; Logo-Stickerei und Druck.',
    faq: [
      ['Was kostet Hosenänderung in Antalya 2025–2026?', 'Hosenänderung ab ₺150. Foto per WhatsApp senden — Antwort in 30 Minuten. Wir ändern Hosen für Damen und Herren.'],
      ['Gibt es einen Herrenschneider in Antalya?', 'Ja! Als Herrenschneider bieten wir Maßanzüge, Hosenänderungen, Hemden nähen, Jackenanpassungen, Ärmel kürzen. WhatsApp: +90 531 898 64 18'],
      ['Gibt es eine Damenschneiderin in Antalya?', 'Ja! Als Damenschneiderin bieten wir Kleider nähen, Röcke kürzen, Kleider ändern, Abendkleider reparieren, Brautkleid anpassen. Übergrößen, Baby- und Kinderkleidung. WhatsApp: +90 531 898 64 18'],
      ['Gibt es eine Nähwerkstatt für Serienproduktion in Antalya?', 'Ja! Unsere Antalya Nähwerkstatt bietet Schnittmuster, Lohnfertigung, Serienproduktion, Musterfertigung. Für Marken und E-Commerce. WhatsApp: +90 531 898 64 18'],
      ...
      ['Preise für chemische Reinigung und Bügeln in Antalya?', 'Reinigung ab ₺300, Mantel ab ₺500, Wäsche und Bügeln ab ₺80/kg. Kurierabholung im Hotel. 24-Stunden-Express.'],
    ...
    seoIntro: 'Schneider Can — erfahrener Schneider in Antalya mit deutschsprachigem Service. Herrenschneider: Maßanzüge, Hosenänderungen, Hemden nähen, Jackenanpassungen. Damenschneiderin: Kleider nähen, Röcke kürzen, Kleider ändern, Brautkleid anpassen, Abendkleider reparieren. Nähwerkstatt: Schnittmuster, Serienproduktion, Lohnfertigung. Hosenänderungen, Reißverschluss, Kleiderreparatur, Maßanfertigung, chemische Reinigung, Bügeln. Uniformproduktion für Hotels, Restaurants, Medizin und Schulen. Express 24–48h. Abholung und Lieferung ins Hotel.',
  },
};
...
const SERVICES = [
  {
    ...
    id: 'paca-kisaltma',
    tr: { n: 'Tamir & Tadilat', d: 'Paça kısaltma · pantolon kısaltma · etek kısaltma · kol kısaltma · elbise daraltma · ceket daraltma · bel alma · fermuar değişimi · yırtık onarımı · düğme dikimi · astar değişimi · cep tamiri. Her tür kıyafette.', p: '₺120+' },
  ...
  {
    icon: '👔',
    img: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=700&q=75&auto=format&fit=crop',
    alt: 'Bay terzi erkek takım elbise dikimi Antalya — Terzi Can',
    id: 'bay-terzi',
    tr: { n: 'Bay Terzi — Erkek Kıyafet Dikimi', d: 'Erkek takım elbise dikimi · erkek pantolon kısaltma · erkek gömlek dikimi · ceket tadilatı · kol kısaltma · blazer dikimi · smoking · damatlık dikimi. Özel ölçü erkek kıyafeti. Tüm Antalya\'ya servis.', p: '₺150+' },
    en: { n: "Men's Tailor — Menswear Antalya", d: "Bespoke men's suits · trouser hemming · shirt making · jacket alterations · sleeve shortening · blazer sewing · tuxedo · groom suit. Custom menswear. Service all Antalya.", p: '₺150+' },
    ru: { n: 'Мужской портной — мужская одежда', d: 'Пошив мужских костюмов · подгонка брюк · пошив рубашек · подгонка пиджаков · укорачивание рукавов · блейзеры · смокинг · костюм жениха. Мужская одежда на заказ.', p: '₺150+' },
    de: { n: 'Herrenschneider — Herrenmode Antalya', d: 'Maßanzüge · Hosenänderungen · Hemden nähen · Jackenanpassungen · Ärmel kürzen · Blazer · Smoking · Bräutigamanzug. Maßanfertigungen für Herren.', p: '₺150+' },
  },
  {
    icon: '👗',
    img: 'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=700&q=75&auto=format&fit=crop',
    alt: 'Bayan terzi elbise dikimi kadın kıyafet tadilatı Antalya — Terzi Can',
    id: 'bayan-terzi',
    tr: { n: 'Bayan Terzi — Kadın Elbise Dikimi', d: 'Kadın elbise dikimi · bluz dikimi · etek dikimi ve kısaltma · elbise daraltma · abiye tamiri · gelinlik tadilatı · nişan elbisesi · kına kıyafeti · büyük beden bayan. Kendi kumaşınızla ya da seçkin stoğumuzdan ölçüye özel.', p: '₺200+' },
    en: { n: "Women's Tailor — Dress Making Antalya", d: "Dress making · blouse sewing · skirt making and shortening · dress taking in · evening gown repair · wedding dress alterations · engagement dress · plus-size women's clothing. Your fabric or ours.", p: '₺200+' },
    ru: { n: 'Женский портной — пошив платьев', d: 'Пошив платьев · блузок · юбок и их укорачивание · ушивание платьев · ремонт вечерних платьев · подгонка свадебных платьев · платье на помолвку · большие размеры.', p: '₺200+' },
    de: { n: 'Damenschneiderin — Damenmode Antalya', d: 'Kleider nähen · Blusen nähen · Röcke nähen und kürzen · Kleider einengen · Abendkleider reparieren · Brautkleid anpassen · Verlobungskleid · Übergrößen.', p: '₺200+' },
  },
  {
    icon: '👶',
    img: 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=700&q=75&auto=format&fit=crop',
    alt: 'Çocuk bebek kıyafeti dikimi büyük beden — Terzi Can Antalya',
    id: 'cocuk-buyuk-beden',
  ...
  },
  {
    ...
    alt: 'Dikiş atölyesi kalıp fason seri imalat Antalya — Terzi Can',
    id: 'dikis-atolyesi',
    tr: { n: 'Dikiş Atölyesi — Fason & Seri İmalat', d: 'Kalıp çıkarma · model tasarımı · kesim · dikim · ütü · paket. Numune dikimi · prototip · seri imalat · fason üretim. Markalar, butikler ve e-ticaret firmaları için tam üretim paketi.', p: 'Teklif Al' },
    en: { n: 'Sewing Workshop — Manufacturing', d: 'Pattern making · model design · cutting · sewing · ironing · packaging. Sample · prototype · mass production · contract manufacturing. Full production for brands, boutiques, e-commerce.', p: 'Get Quote' },
    ru: { n: 'Ателье — серийное производство', d: 'Лекала · дизайн · раскрой · пошив · глажка · упаковка. Образцы · прототип · серийное производство. Полный пакет для брендов и интернет-магазинов.', p: 'Запрос цены' },
    de: { n: 'Nähwerkstatt — Serienproduktion', d: 'Schnittmuster · Modelldesign · Zuschnitt · Nähen · Bügeln · Verpackung. Muster · Prototyp · Serienproduktion. Für Marken, Boutiquen, E-Commerce.', p: 'Angebot' },
  },
  {
    icon: '🪡',
  ...
  },
  {
    ...
    id: 'kuru-temizleme',
    tr: { n: 'Kuru Temizleme & Çamaşır & Ütü', d: 'Kuru temizleme · çamaşır yıkama · ütü hizmeti. Otel ve adreslerden kurye ile alım. 24 saatte teslim. Turistler için ekspres servis.', p: '₺80+/kg' },
    en: { n: 'Dry Cleaning · Laundry · Ironing', d: 'Dry cleaning · laundry · ironing. Courier pickup from hotels and addresses. 24-hour express turnaround. Express service for tourists.', p: '₺80+/kg' },
    ru: { n: 'Химчистка · Стирка · Глажка', d: 'Химчистка · стирка · глажка. Курьер заберёт из отеля или по адресу. Экспресс за 24 часа. Для туристов.', p: '₺80+/кг' },
    de: { n: 'Reinigung · Wäsche · Bügeln', d: 'Chemische Reinigung · Wäsche · Bügeln. Kurierabholung im Hotel oder an der Adresse. 24-Stunden-Express. Für Touristen.', p: '₺80+/kg' },
  },
  {
    icon: '💍',
...
const WHY = [
  ...
  { icon: '👔', tr: ['Bay & Bayan Terzi','Erkek ve kadın kıyafeti için ayrı uzman terzi ekibi.'], en: ['Men & Women','Specialist tailors for both menswear and womenswear.'], ru: ['Мужской и женский','Специалисты по мужской и женской одежде.'], de: ['Herren & Damen','Spezialisierte Schneider für Herren- und Damenmode.'] },
  ...
  { icon: '🏭', tr: ['Dikiş Atölyesi','Fason üretim, kalıp, seri imalat. Markalar için tam paket.'], en: ['Sewing Workshop','Pattern making, mass production. Full package for brands.'], ru: ['Ателье','Лекала, серийное производство для брендов.'], de: ['Nähwerkstatt','Schnittmuster, Serienproduktion für Marken.'] },
...
const PRICES: Record<Lang, string[][]> = {
  ...
  en: [
    ...
    ['Zip — Coat / Jacket','₺300+','24h'],
    ['Dress / Jacket Taking In','₺200+','48h'],
    ['Sleeve Shortening','₺200+','48h'],
    ['Tear Repair','₺100+','Same day'],
    ["Bespoke Men's Suit","₺2,500+",'5–7 days'],
    ["Men's Shirt Sewing","₺400+",'3–5 days'],
    ["Women's Dress Sewing","₺600+",'3–7 days'],
    ['Wedding Dress Alteration','₺500+','3–5 days'],
    ['Evening Gown Repair','₺350+','48h'],
    ['Sweatshirt Sewing','₺400+','3–5 days'],
    ['Dry Cleaning (Dress)','₺300+','48h'],
    ['Dry Cleaning (Coat)','₺500+','48h'],
    ['Laundry & Ironing (kg)','₺80+/kg','24h'],
    ['Uniform (per person)','Quote','Based on qty'],
  ],
  ru: [
    ['Подгонка брюк / юбки','₺150+','24 ч'],
    ['Молния — брюки / джинсы','₺120+','В тот же день'],
    ['Молния — пальто / куртка','₺300+','24 ч'],
    ['Заужение платья / пиджака','₺200+','48 ч'],
    ['Укорочение рукавов','₺200+','48 ч'],
    ['Ремонт разрыва','₺100+','В тот же день'],
    ['Мужской костюм на заказ','₺2.500+','5–7 дней'],
    ['Мужская рубашка на заказ','₺400+','3–5 дней'],
    ['Женское платье на заказ','₺600+','3–7 дней'],
    ['Свадебное платье','₺500+','3–5 дней'],
    ['Вечернее платье','₺350+','48 ч'],
    ['Пошив толстовки','₺400+','3–5 дней'],
    ['Химчистка (платье)','₺300+','48 ч'],
    ['Химчистка (пальто)','₺500+','48 ч'],
    ['Стирка и глажка (кг)','₺80+/кг','24 ч'],
    ['Форма (за чел.)','Запрос','По заказу'],
  ],
  de: [
    ['Hose / Rock kürzen','₺150+','24h'],
    ['Reißverschluss — Hose/Jeans','₺120+','Gleicher Tag'],
    ['Reißverschluss — Mantel','₺300+','24h'],
    ['Kleid / Jacke einengen','₺200+','48h'],
    ['Ärmel kürzen','₺200+','48h'],
    ['Riss reparieren','₺100+','Gleicher Tag'],
    ['Herrenmaßanzug','₺2.500+','5–7 Tage'],
    ['Herrenhemd nähen','₺400+','3–5 Tage'],
    ['Damenkleid nähen','₺600+','3–7 Tage'],
    ['Brautkleid Änderung','₺500+','3–5 Tage'],
    ['Abendkleid Reparatur','₺350+','48h'],
    ['Sweatshirt nähen','₺400+','3–5 Tage'],
    ['Reinigung (Kleid)','₺300+','48h'],
    ['Reinigung (Mantel)','₺500+','48h'],
    ['Wäsche & Bügeln (kg)','₺80+/kg','24h'],
    ['Uniform (pro Person)','Angebot','Je nach Menge'],
  ],
};
...
const GALLERY = [
  { img: 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=700&q=80&auto=format&fit=crop', alt: 'Terzi Can atölyesi dikiş atölyesi Antalya', tr: 'Dikiş Atölyesi', en: 'Sewing Workshop', ru: 'Ателье', de: 'Nähwerkstatt' },
  { img: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=700&q=80&auto=format&fit=crop', alt: 'Bay terzi erkek takım elbise dikimi Antalya', tr: 'Bay Terzi', en: "Men's Tailor", ru: 'Мужской портной', de: 'Herrenschneider' },
  { img: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=700&q=80&auto=format&fit=crop', alt: 'Bayan terzi gelinlik abiye dikimi Antalya', tr: 'Bayan Terzi', en: "Women's Tailor", ru: 'Женский портной', de: 'Damenschneiderin' },
  { img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&q=80&auto=format&fit=crop', alt: 'Kumaş ve dikiş tekstil Antalya terzi', tr: 'Kumaş Seçimi', en: 'Fabric Selection', ru: 'Выбор ткани', de: 'Stoffauswahl' },
  { img: 'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=700&q=80&auto=format&fit=crop', alt: 'Özel dikim elbise kıyafet Antalya', tr: 'Özel Dikim', en: 'Custom Made', ru: 'Пошив на заказ', de: 'Maßanfertigung' },
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .hsub{margin-top:1.6rem;font-size:.92rem;color:var(--cr2);max-width:540px;letter-spacing:.04em;line-height:1.9}
        ...
        .ss{color:var(--mt);margin-top:.7rem;font-size:.88rem;max-width:560px;margin-left:auto;margin-right:auto}
        ...
        /* BAY BAYAN ATOLYE SECTION */
        .bba-sec{background:var(--ink3);padding:5rem 1.5rem}
        .bba-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;margin-top:2.5rem}
        .bba-card{background:rgba(201,169,110,.04);border:1px solid rgba(201,169,110,.12);border-radius:6px;padding:2rem 1.5rem;position:relative;overflow:hidden}
        .bba-card::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,var(--g3),var(--g),transparent)}
        .bba-ic{font-size:2rem;margin-bottom:1rem}
        .bba-h{font-family:var(--serif);font-size:1.15rem;font-weight:700;color:var(--g);margin-bottom:.8rem;line-height:1.3}
        .bba-d{font-size:.81rem;color:var(--cr2);line-height:1.85}
        .bba-cta{margin-top:1.2rem}
        ...
        .stitle{font-family:var(--serif);font-size:1.25rem;font-weight:700;margin-bottom:.5rem}
        ...
        .faqa.open{max-height:320px;padding-bottom:1.2rem}
      ...
      <nav className={`nav${scrolled?' up':''}`} role="navigation" aria-label="Ana navigasyon">
        ...
        <ul className="nav-links">
          <li><a href="#bay-bayan-terzi">{lang==='tr'?'Bay & Bayan':lang==='en'?'Men & Women':lang==='ru'?'Мужской & Женский':'Herren & Damen'}</a></li>
        ...
        <div className="ctr">
          <div className="hc">
            ...
            <div className="hacts fu3">
              ...
              <a href="#bay-bayan-terzi" className="bo">{c.downBtn}</a>
            </div>
          </div>
      ...
      <div style={{background:'var(--ink2)',padding:'2rem 1.5rem'}} id="main-content">
        <div className="ctr">
          <p className="seobl" id="terzi-can-ozet">{c.seoIntro}</p>
        </div>
      </div>

      {/* BAY & BAYAN & ATOLYE SECTION — YENİ */}
      <div className="bba-sec" id="bay-bayan-terzi">
        <div className="ctr">
          <div className="sh">
            <div className="ey">✦ {lang==='tr'?'Bay · Bayan · Dikiş Atölyesi':lang==='en'?'Men · Women · Sewing Workshop':lang==='ru'?'Мужской · Женский · Ателье':'Herren · Damen · Nähwerkstatt'}</div>
            <h2 className="st">{c.bayBayanHeading}</h2>
            <span className="gl" aria-hidden="true"/>
          </div>
          <div className="bba-grid">
            {/* BAY */}
            <article className="bba-card" id="bay-terzi">
              <div className="bba-ic">👔</div>
              <h3 className="bba-h">{c.bayHeading}</h3>
              <p className="bba-d">{c.bayDesc}</p>
              <div className="bba-cta">
                <a href={WA(lang==='tr'?'Merhaba, erkek kıyafeti için bilgi almak istiyorum.':'Hello, I need information about men\'s tailoring.')} target="_blank" rel="noopener noreferrer" className="bg" style={{fontSize:'.72rem',padding:'.65rem 1.2rem'}}>
                  💬 {lang==='tr'?'Bay Terzi Fiyat Al':lang==='en'?'Men\'s Tailor Quote':lang==='ru'?'Мужской портной':'Herrenschneider'}
                </a>
              </div>
            </article>
            {/* BAYAN */}
            <article className="bba-card" id="bayan-terzi">
              ...
              <div className="bba-cta">
                <a href={WA(lang==='tr'?'Merhaba, kadın kıyafeti için bilgi almak istiyorum.':'Hello, I need information about women\'s tailoring.')} target="_blank" rel="noopener noreferrer" className="bg" style={{fontSize:'.72rem',padding:'.65rem 1.2rem'}}>
                  💬 {lang==='tr'?'Bayan Terzi Fiyat Al':lang==='en'?'Women\'s Tailor Quote':lang==='ru'?'Женский портной':'Damenschneiderin'}
                </a>
              </div>
            </article>
            {/* ATOLYE */}
            <article className="bba-card" id="dikis-atolyesi">
              ...
              <div className="bba-cta">
                <a href={WA(lang==='tr'?'Merhaba, dikiş atölyesi ve fason üretim için teklif almak istiyorum.':'Hello, I need a quote for contract manufacturing.')} target="_blank" rel="noopener noreferrer" className="bg" style={{fontSize:'.72rem',padding:'.65rem 1.2rem'}}>
                  💬 {lang==='tr'?'Atölye Teklifi Al':lang==='en'?'Workshop Quote':lang==='ru'?'Запрос ателье':'Atelier-Angebot'}
                </a>
              </div>
            </article>
          </div>
      ...
      <section id="services" style={{background:'var(--ink2)',padding:'0'}} aria-labelledby="services-heading">
        <div className="ctr" style={{padding:'4.5rem 1.5rem 2rem'}}>
          <div className="sh">
            ...
            <h2 className="st" id="services-heading">
              {lang==='tr'?'Antalya Terzi Hizmetleri — Paça Kısaltma, Elbise Dikimi, Üniforma, Dikiş Atölyesi':
               lang==='en'?'Antalya Tailor Services — Hemming, Dress Making, Uniforms, Sewing Workshop':
               lang==='ru'?'Услуги портного в Анталье — подгонка, пошив, форма, ателье':
               'Schneiderei Antalya — Änderungen, Kleider, Uniformen, Nähwerkstatt'}
            </h2>
            <p className="ss">
              {lang==='tr'?'Bay ve bayan için her kıyafete, her bedene, her ihtiyaca özel profesyonel terzilik.':
               lang==='en'?'Professional tailoring for men and women — every garment, size and need.':
               lang==='ru'?'Профессиональный пошив для мужчин и женщин — любая одежда и размер.':
               'Professionelle Schneiderei für Herren und Damen — jedes Kleidungsstück.'}
            </p>
            <span className="gl" aria-hidden="true"/>
          </div>
        </div>
        <div className="svcgrid">
          {SERVICES.map((s,i)=>(
            <article key={i} className="scard" id={s.id}>
        ...
        <div className="galgrid">
          {GALLERY.map((g,i)=>(
            <div key={i} className="gitem">
              <img src={g.img} alt={g.alt} loading="lazy" width="700" height="500"/>
      ...
      <section id="prices" style={{background:'var(--ink3)'}} aria-labelledby="prices-heading">
        <div className="ctr">
          <div className="sh">
            ...
            <h2 className="st" id="prices-heading" id="hizmet-fiyatlari">{c.s_prices}</h2>
            <p className="ss">
              {lang==='tr'?"Başlangıç fiyatları · Kesin teklif için WhatsApp'tan fotoğraf gönderin":
               lang==='en'?'Starting prices · Send a photo on WhatsApp for exact quote':
               lang==='ru'?'Начальные цены · Фото в WhatsApp для точной оценки':
               'Startpreise · Foto per WhatsApp für genaues Angebot'}
            </p>
            <span className="gl" aria-hidden="true"/>
          </div>
        ...
        <div className="ctr">
          <div className="sh">
            ...
            <h2 className="st" id="areas-heading">
              Antalya — {lang==='tr'?'Tüm İlçelere Bay & Bayan Terzi Servisi':lang==='en'?'Men & Women Tailor Service All Districts':lang==='ru'?'Все районы Антальи':'Alle Antalya-Bezirke'}
            </h2>
      ...
      <section id="faq" style={{background:'var(--ink)'}} aria-labelledby="faq-heading">
        <div className="ctr">
          <div className="sh">
            ...
            <h2 className="st" id="faq-heading" id="sik-sorulan-sorular">{c.s_faq}</h2>
            <span className="gl" aria-hidden="true"/>
          </div>
          ...
          <div className="cgrid">
            <address style={{fontStyle:'normal'}}>
              {[
                ...
                {ic:'📍',lbl:lang==='tr'?'Hizmet Bölgesi':lang==='en'?'Service Area':lang==='ru'?'Зона обслуживания':'Servicebereich',val:<span>{lang==='tr'?'Tüm Antalya İlçeleri — Bay & Bayan Terzi':lang==='en'?'All Antalya Districts — Men & Women Tailor':lang==='ru'?'Все районы Антальи':'Alle Antalya-Bezirke'}</span>},
            ...
            <div className="mapbox" aria-label="Konum: Konyaaltı, Antalya">
              ...
              <p style={{fontSize:'.8rem',color:'var(--mt)',textAlign:'center',maxWidth:'200px',lineHeight:'1.6'}}>
                {lang==='tr'?'Tüm Antalya ilçelerine bay ve bayan terzi servisi.':
                 lang==='en'?'Men & women tailor service across all Antalya districts.':
                 lang==='ru'?'Мужской и женский портной по всем районам Антальи.':
                 'Herren- & Damenschneider in alle Antalya-Bezirke.'}
              </p>
      ...
      <footer>
        <div className="ctr" style={{textAlign:'center'}}>
          ...
          <p style={{fontSize:'.73rem',color:'var(--mt)'}}>
            © 2026 SwapHubs — Antalya Bay & Bayan Terzi · Dikiş Atölyesi · +90 531 898 64 18 · swaphubs.com/terzi
          </p>
          <div className="fkws" aria-label="Anahtar kelimeler">
            {[
              ...
              'Dikiş Atölyesi Antalya','Paça Kısaltma','Pantolon Kısaltma','Fermuar Değişimi',
              'Elbise Dikimi Antalya','Elbise Tadilat','Kuru Temizleme','Ütü Hizmeti Antalya',
              'Üniforma Üretimi','Nakış Antalya','Otel Üniforma','Aşçı Üniforma','Gelinlik Tadilatı',
              'Eve Gelen Terzi','Otele Gelen Terzi','Terzi Fiyatları 2026',
              "Men's Tailor Antalya","Women's Tailor Antalya",'Tailor Antalya',
              'Alterations Antalya','Dry Cleaning Antalya','Uniform Antalya',
              'Embroidery Antalya','Mobile Tailor','Sewing Workshop Antalya',
              'Портной Анталья','Мужской портной','Женский портной','Химчистка Анталья',
              'Пошив на заказ','Ателье Анталья','Гостиничная форма',
              'Schneider Antalya','Herrenschneider','Damenschneiderin',
              'Änderungen Antalya','Reinigung Antalya','Nähwerkstatt Antalya',
            ].map(k=>(
