...
const SEO_KEYWORDS = [
  ...
  'Kıyafet Tadilat Nasıl Yapılır', 'Pantolon Nasıl Kısaltılır',
  'Terzi Nereye Gidilir Antalya', 'Ucuz Terzi Nasıl Bulunur',

  // ── TÜRKÇE: ADRESTEN ALIM / MOBİL ───────────────────────────────────
  ...
  'Şifon Elbise Dikimi Antalya', 'Tüvit Ceket Tadilatı', 'Kadife Elbise Dikimi',
  'Denim Kıyafet Tadilatı Antalya', 'Poplin Gömlek Daraltma',

  // ── TÜRKÇE: 2026 GÜNCEL FİYAT ────────────────────────────────────────
  ...
  'Etek Kısaltma Fiyatı 2026', 'Kol Kısaltma Fiyatı Antalya', 'Daraltma Ücretleri 2026',

  // ── TÜRKÇE: MAHALLE / BÖLGE DETAY ────────────────────────────────────
  ...
  'Arapsuyu Terzi', 'Hurma Mahallesi Terzi', 'Sarısu Terzi', 'Gürsu Terzi',
  'Altınkum Terzi', 'Atatürk Mahallesi Terzi Antalya', 'Yenigün Terzi Antalya',

  // ── TÜRKÇE: KURUMSAL ÜNİFORMA DETAY ─────────────────────────────────
  ...
  'Turist Rehberi Üniforması Antalya', 'Transfer Şoförü Kıyafeti', 'Marina Personel Üniforma',

  // ── TÜRKÇE: GOOGLE ARAMALARINDAKİ SIRADIŞI KOMBINASYONLAR ─────────────
  'Bay Terzi Antalya', 'Bayan Terzi Antalya', 'Bay Bayan Terzi Antalya',
  'Elbise Tamiri Antalya', 'Kıyafet Tamiri Antalya', 'Giysi Tamiri Antalya',
  'Numune Dikimi Antalya', 'Model Üretimi Antalya', 'Prova Dikimi Antalya',
  'Kalıp Çıkarma Fiyatı Antalya', 'Ölçüye Göre Dikim Antalya', 'Özel Tasarım Dikim Antalya',
  'Dikiş Atölyesi Antalya', 'Terzi Atölyesi Antalya', 'Dikim Stüdyosu Antalya',
  'Pantolon Paça Kısaltma Antalya', 'Kıyafet Kısaltma Antalya', 'Elbise Kısaltma Antalya',
  'Beden Düşürme Antalya', 'Kıyafet Uyarlama Antalya', 'Giysi Uyarlama Antalya',
  'Terzi Ücretleri Antalya', 'Dikim Ücretleri Antalya', 'Tadilat Ücretleri Antalya',
  'Terzi Fiyatı Öğren', 'Dikim Fiyatı Öğren', 'Tadilat Fiyatı Öğren',

  // ── ENGLISH: EXPATS & TOURISM ────────────────────────────────────────
  'Linen Dress Sewing Antalya', 'Muslin Clothing Tailor Antalya', 'Viscose Dress Alteration',
  'Hotel Pickup Laundry and Tailor', 'Doorstep Tailor Service Antalya',
  'Lara Expat Tailor Service', 'Kundu Hotel Uniform Manufacturer', 'Chef Uniform Embroidery Antalya',
  'Medical Scrubs Production Turkey', 'Custom Made Linen Clothes Antalya',
  'Tailor Near Lara Antalya', 'Tailor Near Konyaalti Beach', 'Express Zipper Repair Antalya',
  'Dress Shortening Cost 2026', 'Alteration Shop Antalya', 'Seamstress Antalya',
  'Clothing Repair Shop Antalya', 'Suit Fitting Antalya', 'Hemming Service Antalya',
  ...
  // ── RUSSIAN: EXPATS & LOCATIONS ──────────────────────────────────────
  'Пошив из льна Анталья', 'Муслиновая одежда на заказ Анталья', 'Ателье Коньяалты Лиман',
  'Ателье Лара Гюзелоба', 'Выездной портной в отель Анталья', 'Ремонт брендовой одежды Анталья',
  'Замена молнии на куртке Анталья', 'Ушить платье по фигуре Анталья', 'Пошив униформы оптом Анталья',
  'Химчистка и терзи Анталья', 'Ателье с доставкой Кунду', 'Пошив штор Лара Анталья',
  ...
  // ── GERMAN: HOTELS & LOCATIONS ───────────────────────────────────────
  'Leinenkleid nähen Antalya', 'Musselin Kleidung Schneiderei Antalya',
  'Schneider Kundu Antalya', 'Hotel Abholservice Schneider Antalya',
  'Kleidung enger machen Preis Antalya', 'Änderungsschneiderei Lara Fener',
  'Uniformen für Hotels Hersteller Antalya', 'Arbeitskleidung mit Logo Stickerei',
  'Reißverschluss reparieren Kosten Antalya', 'Maßanfertigung Kleid Antalya',
];
  ...
  return (
    <>
      ...
      <div style={{ fontFamily: "'Outfit', sans-serif", background: '#faf8f4', minHeight: '100vh', color: '#2c2418' }}>
        ...
        {/* ══════════════════════════════
            ZENGİN İÇERİK — TERZILIK BİLGİ KARTI
        ══════════════════════════════ */}
        <section style={{ padding: '48px 20px 0', background: '#faf8f4' }}>
          <div style={{ maxWidth: 740, margin: '0 auto' }}>
            {/* Ana başlık açıklaması — Google için zengin içerik */}
            <div style={{ background: '#fff', borderRadius: 20, padding: '24px 20px', border: '1px solid #e8dcc8', marginBottom: 16 }}>
              ...
              <p style={{ fontSize: 12, color: '#6b5a4a', lineHeight: 1.9, marginBottom: 10 }}>
                {lang === 'tr'
                  ? 'Terzi Can olarak Antalya\'da 15 yılı aşkın deneyimimizle bay terzi, bayan terzi ve çocuk kıyafeti dikimi hizmeti sunuyoruz. Paça kısaltma, pantolon daraltma, elbise tamiri, ceket tadilatı, kıyafet kısaltma ve her türlü dikiş tamiri atölyemizde gerçekleştirilmektedir. Ölçülere göre kalıp çıkarma, numune dikimi ve model üretimi de hizmetlerimiz arasındadır.'
                  : lang === 'en'
                  ? 'Terzi Can has been Antalya\'s trusted tailor for over 15 years. We offer men\'s and women\'s tailoring, children\'s clothing, trouser hemming, dress alterations, jacket repairs, zip replacements and all types of garment repairs. Pattern making, sample sewing and model production are also available.'
                  : lang === 'ru'
                  ? 'Портной Кан работает в Анталье уже более 15 лет. Мы предлагаем пошив мужской, женской и детской одежды, подгонку брюк, ремонт платьев, ушивание пиджаков, замену молний и все виды ремонта одежды. Также доступны изготовление лекал, пошив образцов и модельный пошив.'
                  : 'Schneider Can ist seit über 15 Jahren der vertrauenswürdige Schneider in Antalya. Wir bieten Herren- und Damenschneiderei, Kinderkleidung, Hosenänderungen, Kleiderreparaturen, Jackenänderungen, Reißverschlussersatz und alle Arten von Kleidungsreparaturen an.'}
              </p>
              <p style={{ fontSize: 12, color: '#6b5a4a', lineHeight: 1.9 }}>
                {lang === 'tr'
                  ? 'Antalya\'nın tüm ilçelerinde — Muratpaşa, Konyaaltı, Kepez, Lara, Belek, Kemer, Alanya ve Manavgat\'ta — araçlı terzi servisimizle adresinize geliyoruz. Yerinde ölçü alıp, dikip, tekrar teslim ediyoruz. Terzi fiyatlarımız rekabetçi olup paça kısaltma ₺150\'den, fermuar değişimi ₺120\'den başlamaktadır.'
                  : lang === 'en'
                  ? 'We serve all Antalya districts — Muratpaşa, Konyaaltı, Kepez, Lara, Belek, Kemer, Alanya and Manavgat — with our mobile tailor service. We come to your address, take measurements on-site, tailor and deliver back. Prices start from ₺150 for hemming and ₺120 for zip replacement.'
                  : lang === 'ru'
                  ? 'Мы обслуживаем все районы Антальи — Муратпаша, Коньяалты, Кепез, Лара, Белек, Кемер, Аланья и Манавгат — с выездным сервисом. Приедем к вам, снимем мерки, сошьём и доставим обратно. Подгонка брюк от ₺150, замена молнии от ₺120.'
                  : 'Wir bedienen alle Antalya-Bezirke — Muratpaşa, Konyaaltı, Kepez, Lara, Belek, Kemer, Alanya und Manavgat — mit unserem mobilen Schneiderdienst. Hosenänderungen ab ₺150, Reißverschluss ab ₺120.'}
              </p>
            </div>

            {/* Hizmet detay kartları — 4 adet, zengin anahtar kelime */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
              {[
                {
                  icon: '✂️',
                  bg: '#fdecea',
                  titles: { tr: 'Paça Kısaltma & Kıyafet Tamiri', en: 'Hemming & Garment Repair', ru: 'Подгонка и ремонт', de: 'Kürzen & Reparatur' },
                  bodies: {
                    tr: 'Pantolon paça kısaltma · etek kısaltma · kol kısaltma · yırtık onarımı · dikiş tamiri · astar değişimi · düğme dikimi. Her türlü bay, bayan ve çocuk kıyafetine tadilat.',
                    en: 'Trouser hemming · skirt shortening · sleeve shortening · tear repair · seam repair · lining replacement · button sewing. Alterations for men, women and children.',
                    ru: 'Подгонка брюк · укорачивание юбок · рукавов · ремонт разрывов · замена подкладки · пришивание пуговиц.',
                    de: 'Hose kürzen · Rock kürzen · Ärmel kürzen · Riss reparieren · Futter ersetzen · Knöpfe annähen.',
                  },
                  kws: 'paça kısaltma · elbise tamiri · kıyafet tadilat',
                },
                {
                  icon: '🔒',
                  bg: '#fff3e0',
                  titles: { tr: 'Fermuar Değişimi — Tüm Kıyafetler', en: 'Zip Replacement — All Garments', ru: 'Замена молний — вся одежда', de: 'Reißverschluss — alle Kleidung' },
                  bodies: {
                    tr: 'Pantolon fermuarı · kot fermuarı · ceket fermuarı · mont fermuarı · elbise fermuarı · sweatshirt fermuarı · çanta fermuarı. Aynı gün servis. Tüm marka ve model kıyafetlerde.',
                    en: 'Trousers · jeans · jacket · coat · dress · sweatshirt · bag zips. Same-day service available. All brands and models.',
                    ru: 'Брюки · джинсы · куртка · пальто · платье · толстовка · сумка. Срочный ремонт в тот же день.',
                    de: 'Hosen · Jeans · Jacke · Mantel · Kleid · Sweatshirt · Tasche. Expressdienst möglich.',
                  },
                  kws: 'fermuar değişimi · kot fermuarı · mont fermuarı',
                },
                {
                  icon: '📐',
                  bg: '#e8f5e9',
                  titles: { tr: 'Daraltma · Beden Küçültme · Kalıp', en: 'Taking In · Size Down · Pattern', ru: 'Заужение · Уменьшение · Лекала', de: 'Einengen · Verkleinern · Schnittmuster' },
                  bodies: {
                    tr: 'Elbise daraltma · pantolon daraltma · ceket daraltma · gömlek daraltma · beden küçültme · beden seti çıkarma · kalıp çıkarma. Ölçülerinize göre numune ve model dikimi.',
                    en: 'Dress · trouser · jacket · shirt taking in · size reduction · pattern set · pattern making. Sample and model sewing to your measurements.',
                    ru: 'Заужение платья · брюк · пиджака · рубашки · уменьшение размера · лекала · образцы.',
                    de: 'Kleid · Hose · Jacke · Hemd einengen · Größe anpassen · Schnittmuster · Proben.',
                  },
                  kws: 'daraltma · beden küçültme · kalıp çıkarma',
                },
                {
                  icon: '👔',
                  bg: '#e3f2fd',
                  titles: { tr: 'Özel Dikim · Bay & Bayan Terzisi', en: 'Custom Sewing · Men\'s & Women\'s', ru: 'Индивидуальный пошив · мужской & женский', de: 'Maßanfertigung · Herren & Damen' },
                  bodies: {
                    tr: 'Erkek takım elbise · gömlek · ceket · blazer dikimi. Bayan elbise · bluz · etek · tulum · abiye · gelinlik dikimi. Ölçüye özel, her tür kumaşta özel tasarım.',
                    en: 'Men\'s suits · shirts · jackets · blazers. Women\'s dresses · blouses · skirts · jumpsuits · evening gowns · wedding dresses. Custom made to measure.',
                    ru: 'Мужские костюмы · рубашки · пиджаки. Женские платья · блузки · юбки · вечерние платья · свадебные платья.',
                    de: 'Herrenanzüge · Hemden · Jacken. Damenkleider · Blusen · Röcke · Abendkleider · Brautkleider.',
                  },
                  kws: 'özel dikim · erkek terzi · bayan terzi',
                },
              ].map((card, i) => (
                <div key={i} style={{ background: card.bg, borderRadius: 16, padding: '16px 14px', border: '1px solid rgba(0,0,0,0.05)' }}>
        ...
        <div style={{ background: '#1c1814', padding: '36px 20px 48px', borderTop: '1px solid rgba(184,149,74,0.12)' }}>
          <div style={{ maxWidth: 700, margin: '0 auto' }}>
            ...
            {[
              ...
              { label: '🪢 Kumaş & Özel Dikiş', words: ['Keten Elbise Dikimi','Müslin Kıyafet','Viskon Elbise Tadilatı','Şifon Elbise Dikimi','Saten Elbise Atölyesi','İpek Elbise Tamiri','Triko Dikiş Tamiri','Deri Mont Astar','Kaşe Kaban Tadilat','Penye Daraltma','Kot Ceket Tadilat'] },
              { label: '🧑 Bay & Bayan & Çocuk Terzisi', words: ['Bay Terzi Antalya','Bayan Terzi Antalya','Bay Bayan Terzi','Elbise Tamiri Antalya','Kıyafet Tamiri Antalya','Numune Dikimi Antalya','Model Üretimi Antalya','Kalıp Çıkarma Fiyatı','Ölçüye Göre Dikim','Dikiş Atölyesi Antalya','Dikim Stüdyosu Antalya'] },
              { label: '📍 Mahalle & Bölge Detay', words: ['Kundu Terzi','Güzeloba Terzi','Altıntaş Terzi','Liman Mahallesi Terzi','Meltem Terzi','Fener Mahallesi Terzi','Şirinyalı Terzi','Arapsuyu Terzi','Hurma Terzi','Sarısu Terzi','Gürsu Terzi','Altınkum Terzi'] },
              { label: '🔍 Soru Tipi & Nasıl Aramaları', words: ['Paça Kısaltma Nasıl Yapılır','Fermuar Nasıl Değiştirilir','Elbise Nasıl Daraltılır','Pantolon Nasıl Kısaltılır','Terzi Nereye Gidilir','Terzi Randevusu Antalya','Terzi Fiyatı Öğren','Dikim Fiyatı Öğren'] },
