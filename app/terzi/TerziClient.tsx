...
const C = {
  tr: {
    ...
    seoP2: 'Antalya erkek terzi, bayan terzi, çocuk kıyafeti dikimi, bebek elbisesi dikimi, anne grubu toplu dikimi, büyük beden dikimi, beden seti çıkarma, sweatshirt dikimi Antalya, eşofman dikimi Antalya, nakış Antalya, logo nakışı, üniforma nakışı, baskı Antalya. Nevresim dikimi, perde dikimi, gömlek dikimi, ceket dikimi, pantolon dikimi. Paça kısaltma fiyatı, daraltma fiyatı, terzi fiyatları, dikim fiyatları Antalya.',
    seoP3: 'Otel üniforma Antalya, resepsiyon üniforma, aşçı üniforma, garson üniforma, meydancı üniforma, personel üniforma, doktor üniforma, hemşire üniforma, işçi üniforma, okul üniforma, spor takım üniforma. Fermuar değişimi, kot fermuarı, mont fermuarı, paça kısaltma, etek kısaltma, abiye tadilatı, her türlü kıyafet tamiri. Antalya terzi servisi — araçlı terzi, adrese teslim. Lara terzi, Konyaaltı terzi, Belek terzi, Kemer terzi, Alanya terzi.',
