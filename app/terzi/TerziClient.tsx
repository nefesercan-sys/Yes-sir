...
const C = {
  ...
  en: {
    ...
    seoP4: '',
    faq: [
      { q: 'How much does trouser hemming cost?', a: 'Trouser hemming starts from ₺150. Price depends on fabric. WhatsApp for a free quote.' },
      { q: 'Do you do zip replacement? Jeans, coat, sweatshirt?', a: 'Yes — trouser zip, jeans zip, coat zip, jacket zip, sweatshirt zip, bag zip. Same-day service available.' },
      { q: 'Do you repair evening gowns and skirts?', a: 'Yes, we repair and alter evening gowns, skirts, wedding dresses and any formal wear. Perfect fit guaranteed.' },
      { q: 'Do you sew sweatshirts and tracksuits?', a: 'Yes, we sew sweatshirts, hoodies, tracksuits — custom or mass production. Embroidery and printing available.' },
      { q: 'Do you produce hotel, restaurant and staff uniforms?', a: 'Yes — hotel uniforms, reception, housekeeping, chef, waiter, valet, spa and animation staff uniforms. Design, pattern, mass production and embroidery all in one place.' },
      { q: 'Do you produce medical, school and sports uniforms?', a: 'Yes, we produce uniforms for every sector: doctors, nurses, pharmacists, factory workers, school uniforms, sports team kits, security, bank staff.' },
      { q: 'Do you offer embroidery and printing?', a: 'Yes — logo embroidery, name embroidery, uniform embroidery, digital print, transfer print and screen print. Affordable for bulk orders.' },
      { q: 'Do you come to my hotel or home?', a: 'Yes! Our mobile tailor covers all Antalya. We visit, measure, tailor and deliver back to you.' },
      { q: 'Plus-size, children\'s clothing, curtains and bed linen?', a: 'Yes — plus-size sewing, children\'s clothing, baby dresses, curtains and bed linen all available.' },
    ],
  },
  ru: {
    ...
    seoP4: '',
    faq: [
      { q: 'Сколько стоит подгонка брюк и замена молнии?', a: 'Подгонка брюк от ₺150, замена молнии от ₺120. Зависит от типа одежды. Напишите в WhatsApp для бесплатной оценки.' },
      { q: 'Вы меняете молнии? Джинсы, куртка, толстовка?', a: 'Да — замена молнии в брюках, джинсах, куртках, пальто, платьях, толстовках, сумках. Срочный ремонт в тот же день.' },
      { q: 'Ремонт вечерних платьев и юбок?', a: 'Да, ремонтируем и подгоняем вечерние платья, юбки, свадебные платья и любую праздничную одежду.' },
      { q: 'Шьёте толстовки и спортивные костюмы?', a: 'Да, шьём толстовки, худи и спортивные костюмы — на заказ или серийно. Доступна вышивка и печать.' },
      { q: 'Производство формы для отелей и ресторанов?', a: 'Да — форма для гостиниц, ресепшн, горничных, поваров, официантов, охраны, спа. Дизайн, лекала, серийное производство, вышивка — всё в одном месте.' },
      { q: 'Медицинская, школьная и спортивная форма?', a: 'Да, шьём форму для всех отраслей: врачи, медсёстры, фармацевты, рабочие, школьная форма, спортивная форма команды.' },
      { q: 'Вышивка и печать на одежде?', a: 'Да — логотип, имя, вышивка на форме, цифровая печать, трафаретная печать. Оптовые цены для больших заказов.' },
      { q: 'Вы приезжаете домой или в отель?', a: 'Да! Выездной портной по всей Анталье. Приедем, снимем мерки, сошьём и доставим.' },
      { q: 'Большие размеры, детская одежда, шторы и постельное бельё?', a: 'Да — одежда больших размеров, детская одежда, платья для малышей, шторы и постельное бельё.' },
    ],
  },
  de: {
    ...
    seoP4: '',
    faq: [
      { q: 'Was kostet Hosenänderung und Reißverschluss-Ersatz?', a: 'Hosenänderung ab ₺150, Reißverschluss ab ₺120. Je nach Kleidungsstück. WhatsApp für ein kostenloses Angebot.' },
      { q: 'Tauschen Sie Reißverschlüsse aus? Jeans, Mantel, Sweatshirt?', a: 'Ja — Hosen, Jeans, Jacken, Mäntel, Kleider, Sweatshirts, Taschen. Expressdienst am gleichen Tag möglich.' },
      { q: 'Reparieren Sie Abendkleider und Röcke?', a: 'Ja, wir reparieren und ändern Abendkleider, Röcke, Brautkleider und festliche Kleidung jeder Art.' },
      { q: 'Nähen Sie Sweatshirts und Trainingsanzüge?', a: 'Ja, Sweatshirts, Hoodies, Trainingsanzüge — auf Maß oder als Serienproduktion. Stickerei und Druck verfügbar.' },
      { q: 'Produzieren Sie Hotel- und Restaurantuniformen?', a: 'Ja — Hotelpersonal, Rezeption, Hausdamen, Köche, Kellner, Sicherheit, Spa. Design, Schnittmuster, Serienproduktion und Stickerei alles aus einer Hand.' },
      { q: 'Medizinische, Schul- und Sportuniformen?', a: 'Ja, wir produzieren Uniformen für alle Branchen: Ärzte, Krankenschwestern, Apotheker, Arbeiter, Schuluniformen, Sportteam-Trikots.' },
      { q: 'Stickerei und Druck auf Kleidung?', a: 'Ja — Logo-Stickerei, Namens-Stickerei, Uniformstickerei, Digitaldruck, Transferdruck und Siebdruck. Günstige Preise für Großbestellungen.' },
      { q: 'Kommen Sie ins Hotel oder nach Hause?', a: 'Ja! Unser mobiler Schneiderdienst fährt in alle Antalya-Bezirke. Wir kommen, messen, schneidern und liefern zurück.' },
      { q: 'Übergrößen, Kinderkleidung, Vorhänge und Bettwäsche?', a: 'Ja — Übergrößen, Kinderkleidung, Babykleider, Vorhänge und Bettwäsche alles verfügbar.' },
    ],
  },
};
        ...
        <div style={{ background: '#1c1814', padding: '36px 20px 48px', borderTop: '1px solid rgba(184,149,74,0.12)' }}>
          <div style={{ maxWidth: 700, margin: '0 auto' }}>
            ...
            {[
              ...
              { label: '🔒 Fermuar & Tamir Detay', words: ['Fermuar Değişimi','Kot Fermuarı','Pantolon Fermuarı','Mont Fermuarı','Sweatshirt Fermuarı','Etek Tamiri','Etek Kısaltma','Abiye Tamiri','Abiye Tadilatı','Her Türlü Kıyafet Tamiri'] },
