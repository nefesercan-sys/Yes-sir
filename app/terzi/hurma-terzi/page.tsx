...
const SITE_URL = 'https://swaphubs.com/terzi/hurma-terzi';
const MAPS_URL = 'https://maps.app.goo.gl/CNZghczJNRQX3mLM9';
const PHONE = '+90 531 898 64 18';
const WA_URL = `https://wa.me/+905318986418?text=${encodeURIComponent('Merhaba, Hurma mahallesinde terzi hizmetiniz hakkında bilgi almak istiyorum.')}`;
  ...
  '@graph': [
    {
      ...
      name: 'Terzi Can — Hurma Konyaaltı Antalya',
      alternateName: ['Hurma Terzi', 'Konyaaltı Hurma Terzi', 'Terzi Can Hurma'],
      description: 'Hurma mahallesi ve çevresine profesyonel araçlı terzi servisi. Paça kısaltma ₺150, fermuar değişimi ₺120, elbise dikimi, bel daraltma, kuru temizleme. Eve gelen terzi Konyaaltı.',
      url: SITE_URL,
      ...
      geo: { '@type': 'GeoCoordinates', latitude: 36.892, longitude: 30.698 },
      hasMap: MAPS_URL,
    ...
    },
    {
      '@type': 'WebPage',
      '@id': `${SITE_URL}#webpage`,
      name: 'Terzi Can Hurma — Paça Kısaltma, Fermuar, Elbise Dikimi Antalya 2026',
      url: SITE_URL,
      isPartOf: { '@id': 'https://swaphubs.com#website' },
      description: 'Hurma mahallesi terzi: paça kısaltma ₺150, fermuar ₺120, elbise dikimi, bel daraltma. Araçlı servis. ☎ +90 531 898 64 18',
      inLanguage: 'tr',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Hurma Terzi', item: SITE_URL },
      ],
    },
    {
      '@type': 'FAQPage',
...
export const metadata = {
  ...
  openGraph: {
    title: 'Terzi Can Hurma — Paça Kısaltma, Fermuar, Elbise Dikimi',
    description: 'Hurma mahallesi terzi: paça kısaltma ₺150, fermuar ₺120, elbise dikimi. Araçlı servis. ☎ +90 531 898 64 18',
    url: SITE_URL,
    siteName: 'SwapHubs',
    locale: 'tr_TR',
    type: 'website',
    images: [{ url: '/og/terzi-can.jpg', width: 1200, height: 630, alt: 'Terzi Can Hurma Antalya' }],
  },
  robots: { index: true, follow: true, googleBot: { index: true, follow: true, 'max-image-preview': 'large', 'max-snippet': -1 } },
  other: {
    'geo.region': 'TR-07',
    'geo.placename': 'Hurma, Konyaaltı, Antalya',
    'geo.position': '36.892;30.698',
    ICBM: '36.892, 30.698',
  },
};
      ...
      <main style={{ fontFamily:"'DM Sans',system-ui,sans-serif", background:'#FAF7F2', color:'#3A3028', minHeight:'100vh' }}>
        ...
        <section style={{ background:'linear-gradient(135deg,#1C1814,#2E2820)', padding:'4rem 1.5rem 3.5rem', position:'relative', overflow:'hidden' }}>
          ...
          <div style={{ maxWidth:'860px', margin:'0 auto', position:'relative' }}>
            <div style={{ fontSize:'.68rem', letterSpacing:'.28em', textTransform:'uppercase', color:'#D4B07A', marginBottom:'1rem' }}>
              📍 Terzi Can · Konyaaltı · Hurma Mahallesi
            </div>
            ...
            <p style={{ color:'rgba(255,255,255,.8)', fontSize:'.92rem', lineHeight:1.85, maxWidth:'560px', marginBottom:'1.5rem' }}>
              ...
              Hurma adresinize araçlı terzi servisi.
            </p>
        ...
        <section style={{ background:'#F7F3ED', padding:'3rem 1.5rem' }}>
          <div style={{ maxWidth:'820px', margin:'0 auto' }}>
            <h2 style={{ fontFamily:'Georgia,serif', fontSize:'1.75rem', color:'#1C1814', marginBottom:'.4rem' }}>
              Hurma Terzi Fiyat Listesi 2026
            </h2>
        ...
        <section style={{ background:'#fff', padding:'3rem 1.5rem' }}>
          <div style={{ maxWidth:'820px', margin:'0 auto' }}>
            <h2 style={{ fontFamily:'Georgia,serif', fontSize:'1.7rem', color:'#1C1814', marginBottom:'1rem' }}>
              Hurma Mahallesi Terzi Can Hizmetleri
            </h2>
            <div style={{ fontSize:'.88rem', color:'#5A4E42', lineHeight:2 }}>
              <p style={{ marginBottom:'1rem' }}>
                <strong>Terzi Can</strong> olarak Antalya Konyaaltı'nın <strong>Hurma</strong> mahallesine
              ...
              <p>
                <strong>Hurma</strong> adresinize geliyor, <strong>yerinde ölçü alıyor</strong>,
        ...
        <section style={{ background:'#1C1814' }}>
          <iframe
            ...
            title="Terzi Can Hurma Konyaaltı Antalya"
            aria-label="Terzi Can Hurma mahallesi konumu"
          />
          <div style={{ padding:'1.2rem 1.5rem', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:'1rem' }}>
            <address style={{ fontStyle:'normal', fontSize:'.83rem', color:'rgba(255,255,255,.75)', lineHeight:1.9 }}>
              <strong style={{ color:'#fff', display:'block', marginBottom:'.2rem' }}>
                Terzi Can — Hurma, Konyaaltı / Antalya
              </strong>
              ...
              📍 Hurma Mahallesi, Konyaaltı, Antalya 07070
            </address>
