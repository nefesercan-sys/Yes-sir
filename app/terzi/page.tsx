...
const jsonLd = {
  ...
  '@graph': [
...

    {
      ...
      // ── Review: her birinde author.name + reviewRating + reviewBody zorunlu ──
      review: [
        {
          '@type': 'Review',
      ...
      // ── hasOfferCatalog: itemOffered ile Service tipi — Offer değil ──────
      hasOfferCatalog: {
        '@type': 'OfferCatalog',
        ...
        itemListElement: [
          ...
          {
            '@type': 'Offer',
            name: 'Elbise Dikimi ve Daraltma',
          ...
          {
            '@type': 'Offer',
            name: 'Üniforma Üretimi — Otel Restoran Sağlık',
            description: 'Otel, restoran, sağlık, okul üniforması. Tasarım + kalıp + seri imalat + nakış.',
            availability: 'https://schema.org/InStock',
            url: SITE_URL,
            seller: { '@type': 'Organization', name: 'Terzi Can' },
          ...
          },
          {
            ...
            description: "Gelinlik tadilatı, abiye tamiri ve kısaltma. ₺350'den başlar.",
            price: '350',
            priceCurrency: 'TRY',
            availability: 'https://schema.org/InStock',
            url: SITE_URL,
            seller: { '@type': 'Organization', name: 'Terzi Can' },
            itemOffered: { '@type': 'Service', name: 'Gelinlik Tadilatı', serviceType: 'Bridal Alteration' },
          },
          {
            '@type': 'Offer',
            name: 'Nakış ve Logo Baskı — Sweatshirt Dikimi',
