...
export const metadata: Metadata = {
  title: 'Antalya Konyaaltı Terzi | Elbise Dikim, Tamir ve Tadilat | 0531 898 64 18',
  ...
  keywords: 'antalya konyaaltı terzi, elbise dikim antalya, terzi tamir tadilat, konyaaltı ütü servisi, liman mahallesi terzi, hurma terzi, uncalı terzi',
  openGraph: {
