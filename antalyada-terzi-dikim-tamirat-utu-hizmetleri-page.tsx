...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      address: {
        '@type': 'PostalAddress',
        // DÜZELTME (2026-09-19): streetAddress önceden 3 mahalle adını üst üste
        // taşıyordu ("Sarısu, Hurma, Liman") — geçersiz PostalAddress formatı.
        // terzihizmeti.com.tr'deki doğru, tek-adres formatıyla değiştirildi.
      ...
      // DÜZELTME (2026-09-19, güncellendi): Koordinat önce 36.8820/30.6980'e
      // çekilmişti (terzihizmeti.com.tr'nin sayfa metnine göre) ama doğrulanmış
      // GBP CID'inin (1496201377277644027) kendi Google Maps embed pini
      // 36.8841/30.7056 gösteriyor — bu, gerçek harita konumunun kanıtı.
      // Doğrulanmış CID'in pinine geri dönüldü.
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px 72px', color: INK, background: '#fff', fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
        ...
        <header style={{ borderBottom: `1px solid ${BORDER}`, paddingBottom: 32, marginBottom: 36 }}>
          ...
          <p className="sh-speakable" style={{ fontSize: 15.5, lineHeight: 1.65, color: INK, background: BG_SOFT, border: `1px solid ${BORDER}`, borderRadius: 14, padding: '16px 18px', margin: '0 0 18px', maxWidth: 660 }}>
            <strong>Kısa cevap:</strong> Terzi Can (SwapHubs), Antalya Konyaaltı'da (Liman Mahallesi)
        ...
        <article style={{ display: 'flex', flexDirection: 'column', gap: 30 }}>
          ...
          <section>
            ...
            <p style={{ fontSize: 15.5, lineHeight: 1.7, color: SUB, margin: 0 }}>
              Terzi Can, Konyaaltı Liman Mahallesi'nde faaliyet gösteren, geleneksel terzilik ustalığını
        ...
        <footer style={{ marginTop: 52, padding: '36px 28px', borderRadius: 20, textAlign: 'center', background: '#111413', color: '#9aa39e' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '6px 18px', fontSize: 13.5, margin: '18px 0 0' }}>
            <span>Liman Mahallesi, 07070 Konyaaltı/Antalya</span>
